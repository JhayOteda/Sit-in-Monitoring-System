...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .card-body { padding: 1.5rem; color: var(--text-muted); text-align: center; min-height: 300px; display: flex; align-items: center; justify-content: center; }
    </style>
</head>
<body>
<nav>
