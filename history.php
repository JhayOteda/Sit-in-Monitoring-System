...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .badge-done, .badge-approved { background: #e6f4ea; color: #155724; }
        .badge-pending { background: #fff3cd; color: #856404; }
        .badge-cancelled, .badge-rejected { background: #fde8e8; color: #a01a1a; }
        .no-data { padding: 2rem; text-align: center; color: var(--text-muted); font-size: 0.9rem; }
    </style>
</head>
<body>
<nav class="d-nav">
...
<div class="d-wrap">
    <div class="d-card">
        ...
        <div class="d-card-body">
            ...
            <?php else: ?>
                <table>
                    <thead><tr><th>#</th><th>Date</th><th>Time In</th><th>Time Out</th><th>Purpose</th><th>Status</th></tr></thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="badge badge-<?= strtolower($log['status'] ?? 'done') ?>"><?= htmlspecialchars($log["status"] ?? "Done") ?></span></td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
