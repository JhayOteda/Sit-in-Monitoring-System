                    ...
                    <form method="POST" action="update_profile.php">
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="id_number" value="<?= htmlspecialchars($user["id_number"]) ?>" readonly>
                            </div>
                            <div class="form-group">
                                <label class="form-label">Course</label>
                                <select class="form-control" name="course" required>
                                    <option value="BSIT" <?= $user["course"] === "BSIT" ? "selected" : "" ?>>Bachelor of Science in Information Technology (BSIT)</option>
                                    <option value="BSCA" <?= $user["course"] === "BSCA" ? "selected" : "" ?>>Bachelor of Science in Customs Administration (BSCA)</option>
                                    <option value="BSCS" <?= $user["course"] === "BSCS" ? "selected" : "" ?>>Bachelor of Science in Computer Science (BSCS)</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="course_level" required>
                                    <option value="1" <?= $user["course_level"] === "1" ? "selected" : "" ?>>1</option>
                                    <option value="2" <?= $user["course_level"] === "2" ? "selected" : "" ?>>2</option>
                                    <option value="3" <?= $user["course_level"] === "3" ? "selected" : "" ?>>3</option>
                                    <option value="4" <?= $user["course_level"] === "4" ? "selected" : "" ?>>4</option>
                                </select>
                            </div>
                        </div>
